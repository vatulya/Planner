...
class Sch_View_Helper_Twitter_Navigation_Menu extends Zend_View_Helper_Navigation_Menu
{
    ...
    protected function _hasActiveChildren(Zend_Navigation_Page $page)
    {
        ...
        foreach ($page->getPages() as /** @var Zend_Navigation_Page $subPage */ $subPage) {
