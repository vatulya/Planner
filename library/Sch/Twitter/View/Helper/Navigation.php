...
/**
 * @class Sch_Twitter_View_Helper_Navigation
 */
class Sch_Twitter_View_Helper_Navigation extends Zend_View_Helper_Navigation
{
     ...
     * @var string
     */
    const NS = 'Sch_Twitter_View_Helper_Navigation';
